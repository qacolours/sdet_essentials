...
public class chromeStandaloneTest_blazedemo extends baseTest {
	
	@Test
	public void loginToApplication() throws Exception {
		
		System.out.println("Started executing test chromeStandaloneTest_blazedemo");
		...
		oDriver.get("https://blazedemo.com/");
